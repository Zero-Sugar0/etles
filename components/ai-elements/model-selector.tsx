...
export const ModelSelectorContent = ({
  ...
  <DialogContent
    className={cn(
      "p-0 sm:max-w-[340px] overflow-hidden border border-border/40 bg-popover/95 backdrop-blur-md shadow-2xl rounded-xl",
      className
    )}
    {...props}
  >
...
export const ModelSelectorInput = ({
  ...
  <CommandInput
    className={cn(
      "h-10 text-xs bg-transparent border-b border-border/20",
      className
    )}
    {...props}
  />
...
export const ModelSelectorList = ({
  ...
  <CommandList
    className={cn(
      "max-h-[300px] p-1.5 overflow-y-auto overflow-x-hidden",
      className
    )}
    {...props}
  />
...
export const ModelSelectorLogo = ({
  ...
  if (hasError) {
    return (
      <div
        className={cn(
          "size-3.5 rounded-full bg-primary/10 flex items-center justify-center border border-primary/20 shrink-0",
          className
        )}
      >
  ...
  return (
    <Image
      alt={`${provider} logo`}
      className={cn(
        "size-3.5 dark:invert rounded-sm object-contain shrink-0",
        className
      )}
      height={14}
