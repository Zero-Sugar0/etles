        ...
        >
          ...
          {!isMobile && (
            <motion.div
              ...
              className="relative h-dvh w-[clamp(340px,32vw,420px)] min-w-0 shrink-0 bg-muted dark:bg-background"
              exit={{
                opacity: 0,
                x: 0,
                scale: 1,
            ...
            >
              ...
              <div className="flex h-full min-h-0 min-w-0 flex-col items-center justify-between">
                <ArtifactMessages
