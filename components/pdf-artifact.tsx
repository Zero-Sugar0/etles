  ...
  return (
    ...
    >
      <div className="min-h-full min-w-0 overflow-x-hidden bg-background p-2 text-foreground sm:p-5 lg:p-8 print:bg-white print:p-0">
        <div
          className="mx-auto max-w-6xl overflow-hidden border border-border/70 bg-background shadow-sm print:border-0 print:shadow-none"
        ...
        >
          ...
          >
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              ...
              <div
                className="shrink-0 text-left text-xs sm:text-right"
          ...
          <main
            className="min-w-0 px-3 py-6 sm:px-8 sm:py-12 lg:px-14"
            ...
            <div className="mx-auto grid max-w-5xl gap-10 xl:grid-cols-[13rem_minmax(0,1fr)]">
                ...
                <aside className="hidden xl:block">
                  ...
                  >
                    {sections.map((section) => (
                      <a
                        className={`text-sm hover:opacity-80 ${section.level === 2 ? "pl-2 text-xs" : "font-medium"}`}
                        href={`#${section.id}`}
                        key={section.id}
                        style={{ color: `#${colors.body}` }}
                      >
              ...
              <div className="grid min-w-0 gap-6">
                {pages.map((pageContent, pageIndex) => (
                  <article
                    className="relative mx-auto aspect-[8.5/11] w-full max-w-[816px] overflow-hidden border shadow-[0_12px_35px_rgba(0,0,0,0.08)] print:aspect-auto print:min-h-0 print:rounded-none print:border-0 print:shadow-none print:[break-after:page]"
                    // biome-ignore lint/suspicious/noArrayIndexKey: page fragments are regenerated from document order
                    ...
                    style={
                      {
                        ...
                        borderColor: `#${colors.wash}`,
                        "--pdf-ink": `#${colors.ink}`,
                        "--pdf-body": `#${colors.body}`,
                      } as CSSProperties
                    }
                  >
                    <div
                      className="flex items-center justify-between border-b px-5 py-3 text-[10px] font-semibold uppercase tracking-[0.16em] sm:px-10"
                      style={{
                        borderColor: `#${colors.wash}`,
                        color: `#${colors.ink}`,
                      }}
                    ...
                    <div
                      className="absolute bottom-0 left-0 right-0 flex items-center justify-between border-t px-5 py-3 text-[10px] sm:px-10"
                      style={{
                        borderColor: `#${colors.wash}`,
                        color: `#${colors.muted}`,
                      }}
          ...
          <footer
            className="border-t px-4 py-3 text-xs sm:px-8 lg:px-12"
            style={{
