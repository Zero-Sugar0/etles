    ...
    <div className="w-full relative overflow-visible bg-black selection:bg-white/20">
      ...
      <section className="relative w-full min-h-[600px] md:min-h-[800px] lg:h-[1000px] overflow-hidden bg-black flex flex-col items-center justify-start pt-[80px] md:pt-[150px]">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-5xl mt-20">
          ...
          >
            <span className="bg-white text-black font-body text-[8px] md:text-xs font-bold md:font-semibold px-2 md:px-2.5 py-0.5 md:py-1 rounded-full uppercase tracking-wider shrink-0">
              New
            </span>
            <span className="text-white/80 font-body text-[10px] md:text-sm pr-2 truncate">
              Introducing Etles — connected to 1000+ tools.
            </span>
          </motion.div>
          ...
          >
            Natural language automation. 85+ AI agents across 15 departments.
            1000+ tool integrations. A C-Suite executive command layer that runs
            your business end-to-end. This is AI agents, wildly reimagined.
          </motion.p>
        ...
        <div className="relative z-10 mt-auto pb-10 md:pb-12 pt-12 md:pt-16 flex flex-col items-center w-full max-w-6xl px-4">
          <div className="liquid-glass rounded-full px-4 py-1.5 mb-6 md:mb-8">
            <span className="font-body text-[10px] md:text-xs text-white/60 uppercase tracking-widest text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-20 opacity-40 hover:opacity-70 transition-opacity duration-700 mix-blend-screen px-4">
            {[
              ...
              <div className="h-6 md:h-8 w-24 md:w-32 relative" key={logo.name}>
                <Image
                  alt={logo.name}
      ...
      <section
        className="relative w-full py-16 md:py-32 px-6 md:px-16 lg:px-24 flex flex-col items-center justify-center"
        id="process"
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto min-h-[500px] justify-center">
          <div className="liquid-glass rounded-full px-4 py-1.5 mb-6 md:mb-8">
            <span className="font-body text-[10px] md:text-xs text-white uppercase tracking-widest">
              How It Works
            </span>
          </div>
          ...
          <p className="font-body font-light text-white/60 text-base md:text-xl max-w-2xl mx-auto leading-relaxed mb-8 md:mb-10">
            Tell Etles what you need in natural language. Our AI connects 1000+
            tools, builds workflows, monitors every event, and executes — all in
            minutes, not months.
          </p>
      ...
      <section
        className="relative w-full py-16 md:py-32 px-6 md:px-16 lg:px-24 max-w-7xl mx-auto flex flex-col items-center"
        id="features"
      >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-16 mb-20 md:mb-32 w-full">
          <div className="flex-1 flex flex-col items-start text-left">
            <h3 className="text-2xl md:text-3xl font-heading italic text-white mb-4 md:mb-6">
              Workflow Automation
            </h3>
            <p className="font-body font-light text-white/60 text-base md:text-lg leading-relaxed mb-6 md:mb-8">
              Etles doesn't just respond to prompts; it plans and executes
              multi-step workflows across your entire tech stack autonomously.
            </p>
            <Link
              className="liquid-glass rounded-full px-5 md:px-6 py-2.5 md:py-3 font-body text-xs md:text-sm font-medium text-white hover:bg-white/5 transition-colors"
              href="/chat"
            >
              Explore Workflows
            </Link>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-10 md:gap-16 w-full mb-12 md:mb-16">
          <div className="flex-1 flex flex-col items-start text-left">
            ...
            <p className="font-body font-light text-white/60 text-base md:text-lg leading-relaxed mb-6 md:mb-8">
              Set it and forget it. Etles listens for triggers across 1000+
              apps. When a high-priority ticket opens in Linear, your agent
          ...
          {[
            {
              ...
              desc: "Composio native integration puts the internet at your command.",
            },
            {
              title: "Semantic Memory",
              desc: "Vector database integration means Etles remembers everything.",
            },
            {
              title: "Cron Scheduling",
              desc: "Conversational scheduling via Upstash QStash. No crontab required.",
            },
            {
              title: "Generative UI",
              desc: "Agents stream custom interactive components directly to your chat.",
            },
          ].map((feature) => (
            <div
              className="liquid-glass p-6 md:p-8 rounded-2xl md:rounded-3xl flex flex-col items-start text-left hover:bg-white/5 hover:border-primary/20 transition-all group"
              key={feature.title}
            >
              ...
              <h4 className="text-lg md:text-xl font-body font-medium text-white mb-2 md:mb-3 tracking-tight group-hover:text-primary transition-colors">
                {feature.title}
              </h4>
              <p className="text-white/50 font-body font-light text-xs md:text-sm leading-relaxed">
                {feature.desc}
              </p>
            </div>
          ))}
      ...
      <section className="relative w-full min-h-[400px] md:min-h-[500px] py-16 md:py-24 px-4 md:px-6 flex items-center justify-center overflow-hidden my-10 md:my-20">
        ...
        <div className="relative z-10 w-full max-w-5xl liquid-glass rounded-[24px] md:rounded-[40px] p-8 md:p-20 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 text-center">
          {[
            ...
            <div className="flex flex-col items-center group" key={s.label}>
              <span
                className={`font-heading italic text-5xl md:text-7xl mb-1 md:mb-2 bg-gradient-to-r ${s.color} bg-clip-text text-transparent transition-all duration-500 group-hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]`}
              >
                {s.stat}
              </span>
              <span className="font-body font-light text-white/50 text-[10px] md:text-sm uppercase tracking-widest group-hover:text-white/80 transition-colors">
                {s.label}
              </span>
            </div>
          ))}
      ...
      <section className="relative w-full py-16 md:py-32 px-6 flex flex-col items-center bg-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto w-full">
          {[
            {
              quote:
                "Etles fully replaced our first-line SDRs. The Composio integration let it directly update our Salesforce pipelines while we slept.",
              author: "Sarah Jenkins",
              role: "VP Sales",
            },
            {
              quote:
                "The Generative UI combined with autonomous execution means my developers spend zero time building internal dashboards.",
              author: "Mark Daoust",
              role: "CTO",
            },
            {
              quote:
                "Being able to say 'schedule a daily summary of high-severity Jira tickets' and have it actually work flawlessly is magic.",
              author: "Elena Rostova",
              role: "Product Ops",
            },
          ].map((t) => (
            <div
              className="liquid-glass p-6 md:p-8 rounded-2xl md:rounded-3xl flex flex-col justify-between text-left h-full group hover:border-white/20 transition-all border border-white/5"
              key={t.author}
            >
              <p className="font-body font-light text-white/80 text-base md:text-lg leading-relaxed mb-6 md:mb-8 transition-colors group-hover:text-white">
                "{t.quote}"
              </p>
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-body text-white text-xs md:text-sm font-medium group-hover:text-primary transition-colors">
                    {t.author}
                  </span>
                  <span className="font-body text-white/40 text-[10px] md:text-xs">
                    {t.role}
                  </span>
                </div>
              </div>
