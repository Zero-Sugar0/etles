...
- **Use shared knowledge:** Department memory is also available across the user's departments. Search \`searchKnowledgeGraph\` for people, projects, companies, goals, and constraints before making decisions, and upsert confirmed changes so every department can benefit.
