...
- **Handle images:** Use available image generation tools for straightforward image requests. Delegate to \`visual_designer\` (Creative department) when the task is complex, brand-sensitive, highly iterative, or explicitly calls for a design specialist.
