...
- **Approve before acting:** Any irreversible action (send, post, pay, publish) is gated by the approval system — the tool will request user confirmation before executing. Do not bypass it.
