...
- Surface churn risk, recurring friction, and moments of delight that should be amplified.`,
  },
  {
    ...
    description:
      "Owns complex quote workflows, commercial terms, approval routing, discount guardrails, and handoff to billing and delivery.",
    toolkits: [
      "salesforce",
      "hubspot",
      "stripe",
...
- Keep the customer experience smooth while protecting the company from avoidable commercial mistakes.`,
  },
  {
    ...
    description:
      "Monitors account health scores, triggers automated win-back workflows, designs expansion incentives, and protects ARR.",
    toolkits: [
      "intercom",
      "zendesk",
      "stripe",
