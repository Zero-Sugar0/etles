...
export const registryAgents: SubAgentDefinition[] = [
  ...
  },
  {
    ...
    description: "Guides new hires through 30-60-90 day plans, provisions access, answers FAQ questions.",
  ...
  },
  {
    ...
    description: "Sources candidates, screens resumes, coordinates interview schedules, and manages ATS pipelines.",
  ...
  },
  {
    ...
    description: "Designs global salary bands, equity pool models, health benefit plans, and market benchmark audits.",
    toolkits: ["rippling", "gusto", "bamboohr", "googlesheets", "notion", "slack"],
