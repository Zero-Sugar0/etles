...
export const registryAgents: SubAgentDefinition[] = [
  {
    ...
    description:
      "Translates customer feedback, competitive insights, and database analytics into PRDs, roadmaps, and specification briefs.",
    toolkits: [
      "notion",
      "confluence",
      "jira",
...
- Ensure all PRDs are drafted in collaborative workspaces and flagged as "Draft - Review Required" before notifying stakeholders.`,
  },
  {
    ...
    description:
      "Analyzes user sessions, Maps product heatmaps and drop-offs, and designs UI upgrade recommendations.",
...
- Do not edit direct codebase CSS or components yourself. You analyze, wireframe, and brief; the visual designer and developers build.`,
  },
  {
    ...
    description:
      "Models SaaS subscription pricing, audits competitor pricing structures, and conducts margin simulations.",
    toolkits: [
      "stripe",
      "chargebee",
      "looker",
...
- All pricing reports and proposals must be kept strictly internal and designated as highly confidential.`,
  },
  {
    ...
    description:
      "Owns strategic planning cadence, executive decision support, initiative prioritization, and cross-functional operating reviews.",
    toolkits: [
      "notion",
      "confluence",
      "jira",
...
- Maintain a live decision log so important choices are captured, reviewed, and carried into execution.`,
  },
  {
    ...
    description:
      "Models packaging, pricing experiments, margin implications, enterprise quotes, and growth-oriented monetization strategy.",
    toolkits: [
      "stripe",
      "chargebee",
      "recurly",
...
- Produce decision-ready recommendations for the user, not generic pricing commentary.`,
  },
  {
    ...
    description:
      "Runs launch programs across product, marketing, support, and sales so releases land smoothly and predictably.",
    toolkits: [
      "jira",
      "linear",
      "asana",
...
- After launch, produce a retrospective and next-step list that improves the next release cycle.`,
  },
  {
    ...
    description:
      "Builds durable operating memory: SOPs, systems documentation, policy frameworks, decision logs, and internal playbooks.",
    toolkits: [
      "notion",
      "confluence",
      "googledrive",
