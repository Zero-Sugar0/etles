...
export const registryAgents: SubAgentDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Orchestrates complex tasks that require multiple specialized agents working in parallel. Spawns specialist agents, waits for their results, and synthesizes a unified output.",
    toolkits: [
      "gmail",
      "notion",
      "slack",
...
- Escalate only high-impact issues that require leadership action or cross-functional change.`,
  },
  {
    ...
    description:
      "Handles regional launch readiness, localization coordination, compliance basics, timezone operations, and cross-border go-to-market execution.",
    toolkits: [
      "gmail",
      "slack",
      "notion",
